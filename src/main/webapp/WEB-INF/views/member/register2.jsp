			...
			<form method="post" action="">
				...
				<div class="form-group">
					<label>학교명</label><input type="text" name="schoolname"
						id="schoolname" class="form-control" value="" required="required">
				</div>
				<div class="form-group">
					<label>학년/반</label><input type="text" name="gradeclass"
						id="gradeclass" class="form-control" value="" required="required">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>탑승장소</label><input type="text" name="boardingplace"
						id="boardingplace" class="form-control" value=""
						required="required">
				</div>
				<div class="form-group">
